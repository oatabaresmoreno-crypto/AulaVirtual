{{-- resources/views/instructor/assignments/show.blade.php --}}
@extends('layouts.app')
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex justify-between">
                        ...
                        <a href="{{ route('instructor.lessons.show', $assignment->lesson) }}"
                    ...
                    <li class="flex justify-between">
                        ...
                        <a href="{{ route('instructor.courses.show', $assignment->lesson->course) }}"
                           class="font-medium text-indigo-600 hover:underline">
